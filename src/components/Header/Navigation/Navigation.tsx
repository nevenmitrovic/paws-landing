...
export default function Navigation({ onDropdownOpen, onDropdownClose }: NavigationProps) {
	...
	useEffect(() => {
		if (openShop || openServices) {
			onDropdownOpen()
		} else {
			onDropdownClose()
		}
	}, [openShop, openServices, onDropdownOpen, onDropdownClose])
				...
				<nav>
					<ul className={styles.navMenu}>
						<li>
							...
							<div className={`${styles.dropdown} ${openShop ? styles.open : styles.close}`}>
						...
						<li>
							...
							<div className={`${styles.dropdown} ${openServices ? styles.open : styles.close}`}>
								<a href='#services'>
